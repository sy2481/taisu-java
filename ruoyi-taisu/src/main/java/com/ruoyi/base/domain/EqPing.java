 ...
 * @date 2022-12-12
 */
public class EqPing extends BaseEntity
{
    ...
    /** 最新檢測時間 */
    @ApiModelProperty("最新檢測時間")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Excel(name = "最新檢測時間", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("ip", getIp())
            .append("port", getPort())
            .append("lastPingTime", getLastPingTime())
            .toString();
    }
}
