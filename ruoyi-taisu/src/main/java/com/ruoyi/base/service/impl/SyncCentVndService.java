...
@Service
public class SyncCentVndService implements ISyncCentVndService {
    ...
    public void sendToCent(ManFactory manFactory){
        HttpUtils.sendJsonPost(centHost+"/api/wechat/faceDataCent/saveFaceForSupplier",
                JSONObject.toJSONString(manFactory));
    }
    ...
    public Map<String, CentMemberBo> getListFromCent(String idCards){
        String url = centHost + "/api/wechat/faceDataCent/getListByIdCardsForSupplier";
