...
public interface SysUserMapper {
     ...
     * @param plateNo        车牌号
     */
    public List<SysUser> getByCommonParams(@Param("idCard") String idCard,
     ...
     * 下发成功后加个标志
     */
    void sendBackStatus(@Param("userId") Long userId, @Param("sendedStatus") Integer sendedStatus);
