...
public class SysDeptServiceImpl implements ISysDeptService
{
     ...
     */
    @Override
    public List<SysDept> getFactory(String chemicals) {
        return deptMapper.getFactory(chemicals);
    }

    @Override
    public List<SysDept> getPlant() {
        return deptMapper.getPlant();
    }

    @Override
    public List<SysDept> getPlantByBuildId(String buildId) {
        return deptMapper.getPlantByBuildId(buildId);
    }
